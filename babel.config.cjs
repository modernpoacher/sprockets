  ...
  [
    'module-resolver', {
      alias: {
        ...
        '@modernpoacher/sprockets/sprockets/table/group': './src/sprockets/table/group/index.jsx',
        '@modernpoacher/sprockets/sprockets/table/title': './src/sprockets/table/title/index.jsx',
        '@modernpoacher/sprockets/sprockets/table': './src/sprockets/table/index.jsx',
